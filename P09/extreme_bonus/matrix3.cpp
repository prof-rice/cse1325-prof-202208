...
Matrix3 Matrix3::operator+ (Matrix3 rhs) {
    return Matrix3{
        data[0][0] + rhs[0][0], data[1][0] + rhs[1][0], data[2][0] + rhs[2][0],
        data[0][1] + rhs[0][1], data[1][1] + rhs[1][1], data[2][1] + rhs[2][1],
        data[0][2] + rhs[0][2], data[1][2] + rhs[1][2], data[2][2] + rhs[2][2]
    };         
}
...
Array3 Matrix3::operator[](int index) {
    return Array3{data[index][0], data[index][1], data[index][2]};
}
...
Array3::Array3(int m0, int m1, int m2) : data{m0, m1, m2} { }
int Array3::operator[](int index) {return data[index];}
