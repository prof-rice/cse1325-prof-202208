...
/* Alternate, more explicit, definition
    return out << '\n' << std::setw(width+1) << m.data[0][0]
                       << std::setw(width+1) << m.data[1][0]
                       << std::setw(width+1) << m.data[2][0] << "\n  "
                       << std::setw(width+1) << m.data[0][1]
                       << std::setw(width+1) << m.data[1][1]
                       << std::setw(width+1) << m.data[2][1] << "\n  "
                       << std::setw(width+1) << m.data[0][2]
                       << std::setw(width+1) << m.data[1][2]
                       << std::setw(width+1) << m.data[2][2] << "\n  ";
*/
